...
class Userservice {
  ...
  Future<Map<String, dynamic>?> getMusicServiceData(MusicLibraryService service) async {
  ...
  Future<void> setMusicServiceData(MusicLibraryService service, Map<String, dynamic> data) async {
    if (user.connectedMusicLibraries[service] != null) {
      for (String key in data.keys) {
  ...
  bool hasMusicService(MusicLibraryService service)  {
